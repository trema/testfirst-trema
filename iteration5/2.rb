...
class RepeaterHub < Trema::Controller
  def packet_in datapath_id, message
    ...
    send_packet_out datapath_id, :packet_in => message, :actions => ActionOutput.new(OFPP_FLOOD)
  end
end
...
describe RepeaterHub do
  ...
  it "should send a flow_mod message" do
    controller("RepeaterHub").should_receive(:send_flow_mod_add).with(0xabc, hash_including(:actions))
